ffmpeg -hide_banner -video_size 1280x720 -framerate 24 -pixel_format rgba -i received_video_delay_500_gop_12.yuv \
       -video_size 1280x720 -framerate 24 -pixel_format yuv420p -i trimmed_published_video_12.yuv \
       -lavfi "libvmaf=log_fmt=json:log_path=delay_500_output_12_vs_12.json:n_threads=8" \
       -f null -
